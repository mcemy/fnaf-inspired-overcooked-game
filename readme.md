...
1. Clone the repository:
   ```bash
   git clone https://github.com/SEU-USUARIO/fnaf-inspired-overcooked-game.git
   ```
...
## License
This project is for educational and indie development purposes.  
Not affiliated with *Overcooked* or *Five Nights at Freddy’s*.
